    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (!FileIsOK("roots.hcp", 1499386784) ||
                ...
                !FileIsOK("20160930\\KPP_synthesized.bin", 776402496) ||
                !FileIsOK("20160930\\KKP_synthesized.bin", 81251424) ||
                !FileIsOK("20160930\\KK_synthesized.bin", 52488))
            {
                return;
            }
